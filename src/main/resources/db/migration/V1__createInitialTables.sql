...
insert into TRIP_INVENTORY values (500, now(), 100, 3);
...
insert into STOP_TIMES  values (1, 1, now(), now(), 1, 3);
...
insert into trips values (600, 300,800, 500, 'trip_headsign');
...
insert into TRIPS_IN_SCHEDULE values (1, 900,500);
...
insert into SALES_RECORDS  values (1001, now(), 'Vibin Raj', 'EKM', 'NYD', 2, 100, 100, 1, 1, 1, now(), 'SUCCESS', 'signature');
